...
const GiselleLogo = () => (
  <svg
    ...
    className="w-64 h-auto text-white fill-current drop-shadow-2xl"
    style={{
...
export default function LightRaysDemo() {
  return (
    <div className="min-h-screen bg-slate-900">
      {/* Hero Section with BackgroundEffects */}
        ...
        <div className="relative z-50 flex items-center justify-center h-full">
          <div className="text-center space-y-8 max-w-4xl mx-auto px-8">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-light text-slate-300">What Powers</h2>
              <p className="text-xl text-slate-300 mb-8">高性能なWebGLシェーダーを使用した美しいライトレイエフェクト</p>
            </div>
