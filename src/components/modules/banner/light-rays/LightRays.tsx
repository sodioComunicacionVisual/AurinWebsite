...
const LightRays: React.FC<LightRaysProps> = ({
  ...
  // Intro animation - returns startAnimation function to call after WebGL init
  const { startAnimation } = useIntroAnimation(uniformsRef, { enabled: introAnimation })
  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      const uniforms: Uniforms = {
        ...
        uIntro: { value: introAnimation ? 0 : 1 }, // Start at 0 if intro enabled, else 1 (fully visible)
      }
      ...
      // Start intro animation after WebGL is initialized and uniforms are ready
      startAnimation()
